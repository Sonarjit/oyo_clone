# Generated by Django 5.1.3 on 2025-02-09 06:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ameneties', models.ManyToManyField(to='vendors.ameneties')),
                ('hotel_owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hotels', to='vendors.hotelvendor')),
            ],
        ),
        migrations.CreateModel(
            name='HotelImages',
            fields=[
                ...
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='vendors.hotel')),
            ],
        ),
        migrations.CreateModel(
            name='HotelManager',
            fields=[
                ...
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hotel_managers', to='vendors.hotel')),
            ],
        ),
    ]
